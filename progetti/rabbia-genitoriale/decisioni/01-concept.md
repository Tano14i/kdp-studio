...
- ha preso **il buco piu' pulito e il piu' rischioso** (A2: nessun libro
...
Tutte, per intero, in `02 Validazione/concept-scartati.md`. In breve:

| Scartata | Motivo |
|---|---|
| A1, guida breve | La sua parte migliore sopravvive in B3 e B8 |
| A3, percorso a tempo | Non sfruttava nessun buco, ne contraddiceva due |
| A4, libro per due genitori | Buco reale, ma pubblico che rischia di non comprare |
| B2, parte da dove sei | Contenuta in buona parte da A2 |
| B5, autore cercabile | **Lascia il buco 7 aperto — condizione al CP2** |
| B6, dice quando non funziona | Era marcata ipotesi: una voce sola |
| C2, audio | C1 fa l'80% a un quarto della fatica |
| C3, nessun bonus | Scartata, ma la sua ragione resta: C1 deve essere **una pagina sola** |
| D1 e D3 | D3 e' il prezzo contro cui si e' scagliata la recensione piu' votata |

## Cosa questa decisione vincola, da qui in avanti

1. **Nessun capitolo di prevenzione.** Se l'outline ne propone uno, appartiene
   a un altro libro: ce ne sono gia' tredici.
2. **Nessun esempio riesce al primo tentativo.** Va nel DNA (CP4) come regola
...
- **Il margine a 9,99-10,99 euro**, sul calcolatore KDP, prima di fissare il
  prezzo al passo 12. Qui non si scrive una cifra a stima: e' l'errore gia'
  registrato tre volte in questo repo.
- **I buchi 6, 7 e 9** restano aperti. Il 6 (scrivere per due genitori) e'
  recuperabile come singolo capitolo dentro A2, e va riproposto al CP3.
- **Le ~350 recensioni a 4 e 5 stelle** di Merini e Petrucciani. L'avatar su cui
  poggia questo concept e' costruito su 24 recensioni tutte negative
  (`02-avatar.md` §8). Il concept si regge sui vincoli, che sono solidi;
  l'outline avra' bisogno di sapere anche cosa i lettori **apprezzano**.
